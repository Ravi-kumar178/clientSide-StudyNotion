...
function CourseCard({courseData,currentCard, setCurrentCard}) {
  ...
  return (
    <div className='w-full font-inter mx-auto'>
        
      
            <div className={`w-full pt-8 pb-6 pl-6 flex flex-col ${courseData.heading === currentCard ? "bg-white  shadow-[12px_12px_0_0] shadow-yellow-50":"bg-richblack-800"}`}
